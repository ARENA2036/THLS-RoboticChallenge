...
Die Teams entwickeln eine **vollständig automatisierte Prozesskette** zur robotergestützten Herstellung eines **hybriden Leitungssatzmoduls**.
...
Die Aufgabe baut auf den vorherigen Challenges (2024/2025) auf und führt diese konsequent in Richtung **seriennaher, integrierter Automatisierung** weiter.
...
Parallel zur physischen Automatisierung untersucht das Begleitforschungsmodul die **digitalen Grundlagen** einer zukünftigen durchgängig automatisierten Leitungssatzfertigung.
...
Engineering-, Simulations- und Toolanbieter (weitere Partner werden laufend ergänzt)
